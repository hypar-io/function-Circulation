...
{
	/// <summary>
	/// Override metadata for CirculationOverride
	/// </summary>
	public partial class CirculationOverride : IOverride
	{
        public static string Name = "Circulation";
	...
	public static class CirculationOverrideExtensions
    {
		/// <summary>
        /// Apply Circulation edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Circulation Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<CirculationOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, CirculationIdentity, bool> identityMatch,
            Func<T, CirculationOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Circulation Overrides to apply — typically `input.Overrides.Circulation`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<CirculationOverride> overrideData,
            Func<T, CirculationIdentity, bool> identityMatch,
            Func<T, CirculationOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Circulation)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Circulation)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Circulation)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<CirculationOverride> edits,
            IList<CirculationOverrideAddition> additions,
            IList<CirculationOverrideRemoval> removals,            Func<CirculationOverrideAddition, T> createElement,
            Func<T, CirculationIdentity, bool> identityMatch,
            Func<T, CirculationOverride, T> modifyElement,
